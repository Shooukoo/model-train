...
def probar_modelo():
    ...
    # Ajusta la ruta si tu carpeta se llama diferente (ej: runs/classify/...)
    ruta_modelo = 'runs/classify/runs_zarzamora/modelo_v4/weights/best.pt'
    ...
    # Vamos a tomar una foto al azar de VALIDACIÓN para probar
    ruta_val = os.path.join('datasets', 'frutas', 'images', 'val')
    
    # Buscamos una imagen real
